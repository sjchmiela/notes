...
\chapter{14 maja 2012 -- \textit{Sprawa polska w czasie II wojny światowej}} % (fold)
\label{cha:14}
\begin{center}
\textbf Sprawdzian: Tematy 16 -- 19.
\end{center}

\section{Działalność rządu na emigracji} % (fold)
...
% section dzia_alno_rz_du_na_emigracji (end)
\section{Stosunku polsko-radzieckie 1941 -- 1943} % (fold)
\label{sec:stosunku_polsko_radzieckie_1941_1943}
    ...
    \subsection{Sprawa Katynia} % (fold)
    ...
    % subsection sprawa_katynia (end)
    \subsection{Polityka} % (fold)
    \label{sub:polityka}
    ...
    % subsection polityka (end)
% section stosunku_polsko_radzieckie_1941_1943 (end)
\chapter{18 maja 2012 -- \textit{Polskie Państwo Podziemne}} % (fold)
\label{cha:18_maja_2012_textit}
    
% chapter 18_maja_2012_textit (end)
\chapter{25 maja 2012 -- \textit{Propaganda w czasie II wojny światowej}} % (fold)
\label{cha:25_maja_2012_textit_propaganda_w_czasie_ii_wojny_wiatowej}

% chapter 25_maja_2012_textit_propaganda_w_czasie_ii_wojny_wiatowej (end)
\end{document}
